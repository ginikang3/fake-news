...
function NewsContent() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const { data, error } = await supabase.storage.from('news-images').upload(fileName, compressedFile);
    ...
    return (
      <div className="min-h-screen bg-white text-black font-sans">
        ...
        <div className="p-5 max-w-2xl mx-auto mt-4 text-left">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 leading-tight mb-8 font-black">{title}</h1>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/95 backdrop-blur-md flex items-center justify-center p-6 z-[9999]">
            <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl text-black">
              <div className="text-7xl mb-5 text-black font-black">🤣</div>
