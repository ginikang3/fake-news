...
export default async function ViewPage({ searchParams }: Props) {
  ...
  const imageUrl = i ? decodeURIComponent(i) : "/thumbnail.png";
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans text-left">
      ...
      <div className="p-5 max-w-2xl mx-auto mt-4 text-left font-black">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-gray-900 leading-tight mb-8 text-left font-black">{titleText}</h1>
        <div className="aspect-video w-full mb-8 shadow-2xl rounded-lg overflow-hidden border border-gray-200 relative bg-gray-100">
           ...
           <div className="absolute bottom-4 left-4 bg-red-600 text-white text-[10px] font-bold px-2 py-1 rounded font-black">IMÁGENES DEL MOMENTO</div>
        </div>
        <div className="space-y-6 text-gray-800 leading-relaxed text-lg text-left font-black">
          ...
          <p className="text-left font-black">Fuentes oficiales han confirmado hace apenas unos minutos un suceso que ha dejado a la comunidad internacional에 충격을 주고 있습니다.</p>
        </div>
      </div>
      <ClientSideModal />
    </div>
